...
class AccountInfoSignUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Form(
        key: Get.find<SignUpController>().infoKey,
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              initialValue: Get.find<SignUpController>().signupData['full_name'],
              onSaved: (value) => Get.find<SignUpController>()
                  .signupData['full_name'] = value,
              validator: (v)=>!GetUtils.isLengthGreaterOrEqual(v, 8)?'Full name is too short':null,
            ...
            TextFormField(
              ...
              initialValue:
                  Get.find<SignUpController>().signupData['email'],
              onSaved: (value) =>
                  Get.find<SignUpController>().signupData['email'] = value,
